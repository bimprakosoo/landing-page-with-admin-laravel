...
<div id="page">
        ...
        <div class="row justify-content-between align-items-center">
          ...
          <div class="col-xl-3 col-auto">
            <div class="header-logo">
              <a href="index.html">
                <img class="dark-logo" src="{{ asset('images/logo/dark-logo.png') }}" alt="Logo">
                <img class="light-logo" src="{{ asset('images/logo/light-logo.png') }}" alt="Logo">
              </a>
            </div>
          </div>
          <!-- Header Logo End -->
              ...
              <ul>
                <li class="has-children position-static">
                  ...
                  <ul class="mega-menu">
                    <li>
                      <ul>
                        <li><a href="index.html"><span class="menu-text">MaxCoach Education <span
                                class="badge">Hot</span></span></a></li>
                        <li><a href="index-2.html"><span class="menu-text">Course Portal</span></a></li>
                        <li><a href="index-3.html"><span class="menu-text">Distant Learning <span
                                class="badge">Hot</span></span></a></li>
                    ...
                    <li>
                      <ul>
                        ...
                        <li><a href="index-11.html"><span class="menu-text">Kitchen Coach <span class="badge primary">New</span></span></a>
                        </li>
                    ...
                    <li class="menu-item-50">
                      <ul>
                        <li><a href="#"><img src="../resources/images/menu/mega-menu.jpg" alt="menu-image"></a></li>
                      </ul>
                    </li>
                  </ul>
                </li>
  ...
  <div class="intro10-section section section-fluid fix" data-bg-color="#fbf9f6">
    ...
    <span data-depth="3">
        <img src="{{ asset('images/intro/intro10/artist-shape-01.png') }}" alt="">
    </span>
    </div>
    <div class="shape shape-2">
    <span data-depth="3">
        <img src="{{ asset('images/intro/intro10/artist-shape-02.png') }}" alt="">
    </span>
    </div>
    <div class="shape shape-3">
    <span data-depth="3">
        <img src="{{ asset('images/shape-animation/shape-2.svg') }}" alt="" class="svgInject">
    </span>
    </div>
    <div class="shape shape-4">
    <span data-depth="3">
        <img src="{{ asset('images/intro/intro10/artist-shape-03.png') }}" alt="">
    </span>
    </div>
    <div class="shape shape-5">
    <span data-depth="3">
        <img src="{{ asset('images/intro/intro10/artist-hero-image-03.png') }}" alt="">
    </span>
    </div>
    <div class="shape shape-6">
    <span data-depth="3">
        <img src="{{ asset('images/intro/intro10/artist-shape-05.png') }}" alt="">
    </span>
    </div>
    ...
    <span data-depth="3">
        <img src="{{ asset('images/intro/intro10/maxcoach-shape-12.png') }}" alt="">
    </span>
    </div>
    <div class="shape shape-9">
    <span data-depth="3">
        <img src="{{ asset('images/intro/intro10/artist-shape-04.png') }}" alt="">
    </span>
    </div>

    <div class="shape shape-10 scene">
      <span data-depth="-3"><img src="{{ asset('images/intro/intro10/artist-hero-image-02.jpg') }}" alt=""></span>
    </div>
    <div class="shape shape-11 scene">
      <span data-depth="-3"><img src="{{ asset('images/intro/intro10/artist-hero-image-01.jpg') }}" alt=""></span>
    </div>
    <div class="shape shape-12 scene">
      <span data-depth="-3"><img src="{{ asset('images/intro/intro10/artist-hero-image-04.jpg') }}" alt=""></span>
    </div>
    <!-- Animation Shape End -->
  ...
  <div class="artist-coaching-section section section-padding-t80-b100">
    <div class="container">
      ...
      <div class="section-title-three text-center" data-aos="fade-up">
        <span class="sub-title">Artist coaching</span>
        <h2 class="title">I understand what it takes to create. I can help you with</h2>
      </div>
      <!-- Section Title End -->
  ...
  <!-- Artist Coaching Section End -->

  <!-- Artist Quote Section Start -->
  <div class="artist-quote-section section section-padding-bottom">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-xl-5 col-lg-6 col-12">
          <div class="artist-quote-left">
            <div class="quote-image">
              <img src="{{ asset('images/icons/artist-quote-icon.png') }}" alt="">
            </div>
            <div class="quote-content">
              <h2 class="title">I coach and mentor visual artists, like you, to Create Like You Mean It</h2>
        ...
        <div class="col-xl-6 offset-xl-1 col-lg-6 col-12">
          <div class="artist-quote-right">
            <p>As a coach and mentor, my ultimate goal is to motivate visual artists toward inspired action. I help you
              get you back on track to being the productive, creative, meaningful and authentic artist you truly want to
              be.I support artists in crafting and living a creative life as well as feeling good about themselves and
              their art.</p>

            <p>As an artist and an educator for nearly 30 years, I understand what it takes to create. </p>

            <a href="JavaScript:Void(0);" class="btn btn-light-orange btn-hover-primary-three">Get started today</a>
          </div>
        </div>
      </div>
    </div>
  </div>
  <!-- Artist Quote Section End -->

  <!-- Video Section Start -->
  <div class="video-section section section-padding-top position-relative">
    <div class="container">
      <!-- About Me Video Wrapper Start -->
      <div class="about-me-video-wrapper">

        <!-- About Me Video Start -->
        <a href="https://www.youtube.com/watch?v=eS9Qm4AOOBY" class="about-me-video video-popup mb-0"
           data-aos="fade-up">
          <img class="image" src="{{ asset('images/about/about-me/artist-video-poster.jpg') }}" alt="">
          <img class="icon" src="{{ asset('images/icons/icon-youtube-play.png') }}" alt="">
        </a>
        <!-- About Me Video End -->
...
<img src="{{ asset('images/shape-animation/shape-2.svg') }}" alt="" class="svgInject">
        ...
        <div class="shape shape-2 scene">
          <span data-depth="-3"><img src="{{ asset('images/shape-animation/shape-3.png') }}" alt=""></span>
        </div>
        <div class="shape shape-3 scene">
          <span data-depth="4">shape 3</span>
        </div>
        <div class="shape shape-4 scene">
          <span data-depth="4"><img src="{{ asset('images/shape-animation/shape-1.png') }}" alt=""></span>
        </div>
        <!-- Animation Shape End -->
    ...
    <div class="section-bottom-shape-five d-none d-md-block">
  ...
  <div class="testimonial-section section section-padding-t80-b100" data-bg-color="#faf8f6">
    <div class="container-fluid pl-80 pl-lg-15 pl-md-15 pl-sm-15 pl-xs-15 pr-80 pr-lg-15 pr-md-15 pr-sm-15 pr-xs-15">
      ...
      <div class="section-title-three text-center" data-aos="fade-up">
        ...
        <h2 class="title">Why do people love me?</h2>
      </div>
      <!-- Section Title End -->
  ...
  <div class="section section-padding-t80-b100 section-fluid-two course7-animation-shape">
    <div class="container">
      ...
      <div class="row row-cols-xl-4 row-cols-lg-3 row-cols-md-2 row-cols-1 max-mb-n30">
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="{{ asset('images/courses/330/artist-course-1.jpg') }}" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$40<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">The Acrylic Painting Academy</a></h3>
              <ul class="meta">
                <li><i class="far fa-file-alt"></i>4 Lessons</li>
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="{{ asset('images/courses/330/artist-course-2.jpg') }}" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$21<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">Drawing and Shading: Complete Course</a>
              </h3>
              <ul class="meta">
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="{{ asset('images/courses/330/artist-course-3.jpg') }}" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$19<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">The Color Theory for Digital Artist</a>
              </h3>
              <ul class="meta">
                <li><i class="far fa-file-alt"></i>7 Lessons</li>
                <li><i class="far fa-user-alt"></i>51 Students</li>
              </ul>
            </div>
          </div>
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="{{ asset('images/courses/330/artist-course-4.jpg')}}" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$35<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">Ultimate Guide to Digital Sketching for
                  Beginner</a></h3>
              <ul class="meta">
                <li><i class="far fa-file-alt"></i>14 Lessons</li>
                <li><i class="far fa-user-alt"></i>51 Students</li>
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="{{ asset('images/courses/330/artist-course-5.jpg')}}" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$19<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">Portrait Drawing The Smart Way</a></h3>
              <ul class="meta">
                <li><i class="far fa-file-alt"></i>2 Lessons</li>
                <li><i class="far fa-user-alt"></i>51 Students</li>
              </ul>
            </div>
          </div>
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="{{ asset('images/courses/330/artist-course-6.jpg')}}" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$19<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">Mastering Watercolor Painting from
                  Beginner</a></h3>
              <ul class="meta">
                <li><i class="far fa-file-alt"></i>9 Lessons</li>
                <li><i class="far fa-user-alt"></i>51 Students</li>
              </ul>
            </div>
          </div>
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="{{ asset('images/courses/330/artist-course-7.jpg')}}" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$25<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">The Art & Science of Drawing</a></h3>
              <ul class="meta">
                <li><i class="far fa-file-alt"></i>4 Lessons</li>
                <li><i class="far fa-user-alt"></i>51 Students</li>
              </ul>
        ...
        <div class="col max-mb-30" data-aos="fade-up">
          <div class="course-7">
            <div class="thumbnail">
              <a href="course-details-standard-sidebar.html" class="image">
                <img src="../resources/images/courses/330/artist-course-8.jpg" alt="Course Image">
              </a>
            </div>
            <div class="info">
              <span class="price">$22<span>.00</span></span>
              <h3 class="title"><a href="course-details-standard-sidebar.html">The Colored Pencil Drawing Course</a>
              </h3>
              <ul class="meta">
      ...
      <div class="row max-mt-40">
        <div class="text-center col-lg-7 mx-auto">
          <a href="courses-grid-1.html" class="btn btn-primary-three btn-hover-secondary-three"> View all courses <i
  ...
  <!-- Blog Section Start -->
  <div class="blog-section section section-padding-t80-b100 bg-pattern-one" data-bg-color="#f5f7fa"
       data-bg-image="../resources/images/bg/maxcoach-shape-03.png">
    <div class="container blog-shape-animation">
      <!-- Section Title Start -->
      <div class="section-title-three text-center" data-aos="fade-up">
        <span class="sub-title">Articles and Tips</span>
      ...
      <div class="row isotope-grid">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 grid-item" data-aos="fade-up">
          <div class="blog-2 primary-three mt-150 mt-md-0 mt-sm-0 mt-xs-0 mb-30">
            <div class="thumbnail">
              <a href="blog-details.html" class="image"><img src="../resources/images/blog/270/artist-blog-01.jpg"
                                                             alt="Blog Image"></a>
            </div>
            <div class="info">
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 plr-40 grid-item" data-aos="fade-up">
          <div class="blog-2 primary-three mb-30">
            <div class="thumbnail overlay-thumb">
              <a href="blog-details.html" class="image"><img src="../resources/images/blog/500/artist-blog-02.jpg"
                                                             alt="Blog Image"></a>
            </div>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 grid-item" data-aos="fade-up">
          <div class="blog-2 primary-three mt-50 mt-sm-0 mt-xs-0 mb-30">
            <div class="thumbnail">
              <a href="blog-details.html" class="image"><img src="../resources/images/blog/270/artist-blog-03.jpg"
                                                             alt="Blog Image"></a>
            </div>
            <div class="info">
              <a href="blog-details.html" class="category">Artist</a>
      ...
      <div class="row max-mt-70">
        <div class="text-center col-lg-7 mx-auto">
          <a class="link link-lg primary-three" href="blog-grid.html">Get into details now?​
            <mark>View all posts <i class="far fa-long-arrow-right"></i></mark>
          </a>
        </div>
      </div>
      ...
      <div class="shape shape-2 scene">
        <span data-depth="-3"><img src="../resources/images/shape-animation/shape-3.png" alt=""></span>
      </div>
      <div class="shape shape-3 scene secondary-three">
                    <span data-depth="3">
                        <img src="../resources/images/shape-animation/shape-2.svg" alt="" class="svgInject">
                    </span>
      </div>
      <!-- Animation Shape End -->
    </div>
  ...
  <!-- Event Section Start -->
  <div class="section section-padding-t80-b100">
    <div class="container">
      ...
      <div class="row row-cols-lg-2 row-cols-md-2 row-cols-1 max-mb-n70">

        <div class="col max-mb-70">
          <div class="event-list">
            <div class="thumbnail">
              <a href="event-details.html" class="image"><img src="../resources/images/event/270/event-1.jpg"
                                                              alt="Event Image"></a>
            </div>
            <div class="info">
        ...
        <div class="col max-mb-70">
          <div class="event-list">
            <div class="thumbnail">
              <a href="event-details.html" class="image"><img src="../resources/images/event/270/event-2.jpg"
                                                              alt="Event Image"></a>
            </div>
            <div class="info">
        ...
        <div class="col max-mb-70">
          <div class="event-list right-style">
            <div class="thumbnail">
              <a href="event-details.html" class="image"><img src="../resources/images/event/270/event-3.jpg"
                                                              alt="Event Image"></a>
            </div>
            <div class="info">
        ...
        <div class="col max-mb-70">
          <div class="event-list right-style">
            <div class="thumbnail">
              <a href="event-details.html" class="image"><img src="../resources/images/event/270/event-4.jpg"
                                                              alt="Event Image"></a>
            </div>
            <div class="info">
  ...
  <div class="newsletter-section section newsletter10-shape-animation" data-bg-color="#244186">
    <div class="container">
      <div class="row align-items-center">
        <div class="col-lg-4 col-md-4">
          <div class="newsletter-content-wrap">
            <div class="newsletter-title">
              <h3 class="title">Newsletter to get in touch</h3>
            </div>
          </div>
        </div>
        <div class="col-lg-8 col-md-8">
          <div class="newsletter-form-area">
            <form action="#">
              ...
              <button class="form-submit"><i class="far fa-long-arrow-right"></i></button>
            </form>
          </div>
        </div>
      </div>
    ...
    <div class="shape shape-1">
                <span data-depth="3">
                    <img src="../resources/images/shape-animation/artist-shape-color-paint-top-left.png" alt="">
                </span>
    </div>
    <div class="shape shape-2">
                <span data-depth="3">
                    <img src="../resources/images/shape-animation/artist-shape-color-paint-bottom-right.png" alt="">
                </span>
    </div>
  </div>
  <!-- Newsletter Section End -->

  <div class="footer-section section section-fluid-two">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-4 col-md-12 col-12 max-mb-50">
          <div class="footer-widget">
            ...
            <div class="footer-widget-content">
              ...
              <div class="footer-social-inline primary-three">
        ...
        <div class="col-lg-2 col-md-3 col-sm-7 col-12 max-mb-50">
          <div class="footer-widget">
            ...
            <div class="footer-widget-content primary-three">
              <ul>
        ...
        <!-- Footer Widget Start -->
        <div class="col-lg-4 col-md-6 col-12 max-mb-50">
          <div class="footer-widget">
            <h4 class="footer-widget-title">Address</h4>
            <div class="footer-widget-content">
              <div class="mc-intagram-list instagram-grid">
                <div class="instagram-grid-wrap instagram-grid-3">
                  <!-- Start Single Instagram -->
                  <div class="item-grid grid-style--1">
                    <div class="thumb">
                      <a href="#">
                        <img src="../resources/images/instagram/instagram-md-1.jpg" alt="instagram images">
                      </a>
                      <div class="item-info">
                        <div class="inner">
                  ...
                  <div class="item-grid grid-style--1">
                    <div class="thumb">
                      <a href="#">
                        <img src="../resources/images/instagram/instagram-md-2.jpg" alt="instagram images">
                      </a>
                      <div class="item-info">
                        <div class="inner">
                  ...
                  <div class="item-grid grid-style--1">
                    <div class="thumb">
                      <a href="#">
                        <img src="../resources/images/instagram/instagram-md-3.jpg" alt="instagram images">
                      </a>
                      <div class="item-info">
                        <div class="inner">
                          <a href="#"><i class="fas fa-heart"></i>1k</a>
  ...
  <div class="site-main-mobile-menu-inner">
    <div class="mobile-menu-header">
      <div class="mobile-menu-logo">
        <a href="index.html"><img src="../resources/images/logo/dark-logo.png" alt=""></a>
      </div>
              ...
              <li>
                <ul>
                  ...
                  <li><a href="index-11.html"><span class="menu-text">Kitchen Coach <span
                          class="badge primary">New</span></span></a></li>
                  <li><a href="index-12.html"><span class="menu-text">Motivation <span class="badge primary">New</span></span></a>
                  </li>
                </ul>
              </li>
              <li class="menu-item-50">
                <ul>
                  <li><a href="#"><img src="{{ asset('images/menu/mega-menu.jpg')}}" alt="menu-image"></a></li>
                </ul>
              </li>
            </ul>
          </li>
            ...
            <ul class="sub-menu">
              ...
              <li class="has-children">
                ...
                <ul class="sub-menu">
                  ...
                  <li><a href="course-details-sticky-feature-bar.html"><span
                        class="menu-text">Sticky Features Bar</span></a></li>
                  <li><a href="course-details-standard-sidebar.html"><span class="menu-text">Standard Sidebar</span></a>
                  </li>
                  <li><a href="course-details-no-sidebar.html"><span class="menu-text">No Sidebar</span></a></li>
                </ul>
              </li>
...
<script src="../resources/js/vendor/jquery-migrate-3.3.2.min.js"></script>
<script src="../resources/js/vendor/bootstrap.bundle.min.js"></script> -->

<!-- Plugins JS -->
<!-- <script src="../resources/js/plugins/parallax.min.js"></script>
<script src="../resources/js/plugins/jquery.ajaxchimp.min.js"></script> -->
